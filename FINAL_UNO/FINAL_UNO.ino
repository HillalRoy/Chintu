...
const int backwardpin = 1;
const int turnrightpin = 8;
const int turnleftpin = 12;
const int manualPin = 13;
...
void manualmode() {
  if (forwardpin == HIGH)
    moveForward();
  else if (backwardpin == HIGH)
    moveBackward();
  else if (turnleftpin == HIGH)
    turnLeft();
  else if (turnrightpin == HIGH)
    turnRight();
  else {
    moveStop();
  }
